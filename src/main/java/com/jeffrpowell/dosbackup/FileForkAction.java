...
public class FileForkAction<C> extends RecursiveAction{
    ...
    public FileForkAction(Path workingDir, BiConsumer<Path, C> fileAction, BiConsumer<Path, C> directoryAction, C configContainer, BiConsumer<Path, Throwable> exceptionHandler, Consumer<Progress> progressHandler) {
